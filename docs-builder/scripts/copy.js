...
(async function main() {
  ...
  await fse.copy(path.join(UI_LIBRARY_PATH, '/dist'), path.join(__dirname, '../src/.vuepress/lib/dist'));

  await fse.copy(path.join(UI_LIBRARY_PATH, '/loader'), path.join(__dirname, '../src/.vuepress/lib/loader'));
  ...
  await fse.copy(path.join(UI_LIBRARY_PATH, '/CHANGELOG.md'), path.join(__dirname, '../src/CHANGELOG.md'));
