        ...
        <mock:shadow-root>
          <label class="switch" htmlfor="switch-1" part="base">
            <span class="switch__control" part="control">
              ...
              <input aria-checked="false" aria-labelledby="switch-label-1" id="switch-1" role="switch" type="checkbox" value="">
            </span>
      ...
      <six-switch checked="">
        <mock:shadow-root>
          <label class="switch switch--checked" htmlfor="switch-2" part="base">
            <span class="switch__control" part="control">
              <span class="switch__thumb" part="thumb"></span>
              <input aria-checked="true" aria-labelledby="switch-label-2" checked="" id="switch-2" role="switch" type="checkbox" value="">
            </span>
