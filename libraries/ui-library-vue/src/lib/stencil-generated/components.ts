...
export const SixBreadcrumbs: StencilVueComponent<JSX.SixBreadcrumbs> = /*@__PURE__*/ globalThis.window ? defineContainer<JSX.SixBreadcrumbs>('six-breadcrumbs', undefined, [
  'separatorIcon'
]) : defineStencilSSRComponent<JSX.SixBreadcrumbs>({
  tagName: 'six-breadcrumbs',
  hydrateModule: import('@six-group/ui-library/hydrate'),
  props: {
    'separatorIcon': [String, "separator-icon"]
  }
});


export const SixBreadcrumbsItem: StencilVueComponent<JSX.SixBreadcrumbsItem> = /*@__PURE__*/ globalThis.window ? defineContainer<JSX.SixBreadcrumbsItem>('six-breadcrumbs-item', undefined, [
  'href',
  'target',
  'size',
  'readonly'
]) : defineStencilSSRComponent<JSX.SixBreadcrumbsItem>({
...
export const SixRating: StencilVueComponent<JSX.SixRating> = /*@__PURE__*/ globalThis.window ? defineContainer<JSX.SixRating>('six-rating', undefined, [
  'name',
  'value',
  'disabled',
  'required',
  ...
  'six-rating-change',
  'six-rating-focus'
]) : defineStencilSSRComponent<JSX.SixRating>({
  tagName: 'six-rating',
  hydrateModule: import('@six-group/ui-library/hydrate'),
  props: {
    'name': [String, "name"],
    ...
    'readonly': [Boolean, "readonly"],
    'helpText': [String, "help-text"],
    'onSix-rating-blur': [Function],
    'onSix-rating-change': [Function],
    'onSix-rating-focus': [Function]
  }
});
