...
export const SetAttributes = /*@__PURE__*/ defineContainer<JSX.SetAttributes>('set-attributes', undefined, ['value']);
...
export const SixAvatar = /*@__PURE__*/ defineContainer<JSX.SixAvatar>('six-avatar', undefined, ['image', 'alt', 'initials', 'shape']);

export const SixBadge = /*@__PURE__*/ defineContainer<JSX.SixBadge>('six-badge', undefined, ['type', 'pill', 'pulse']);
...
export const SixCheckbox = /*@__PURE__*/ defineContainer<JSX.SixCheckbox>(
  'six-checkbox',
  undefined,
  [
    'name',
...
export const SixDatepicker = /*@__PURE__*/ defineContainer<JSX.SixDatepicker>(
  'six-datepicker',
  undefined,
  [
    'type',
...
export const SixForm = /*@__PURE__*/ defineContainer<JSX.SixForm>('six-form', undefined, ['novalidate', 'six-form-submit', 'six-form-change', 'six-form-reset']);

export const SixGroupLabel = /*@__PURE__*/ defineContainer<JSX.SixGroupLabel>('six-group-label', undefined, ['size', 'label', 'helpText', 'disabled', 'required']);
...
export const SixIcon = /*@__PURE__*/ defineContainer<JSX.SixIcon>('six-icon', undefined, ['size', 'filled']);

export const SixIconButton = /*@__PURE__*/ defineContainer<JSX.SixIconButton>('six-icon-button', undefined, ['name', 'size', 'label', 'disabled', 'html']);

export const SixInput = /*@__PURE__*/ defineContainer<JSX.SixInput>(
  'six-input',
  undefined,
  [
    'type',
...
export const SixLayoutGrid = /*@__PURE__*/ defineContainer<JSX.SixLayoutGrid>('six-layout-grid', undefined, ['columns']);

export const SixMainContainer = /*@__PURE__*/ defineContainer<JSX.SixMainContainer>('six-main-container', undefined, ['padded']);
...
export const SixMenuItem = /*@__PURE__*/ defineContainer<JSX.SixMenuItem>('six-menu-item', undefined, ['checked', 'value', 'disabled']);

export const SixMenuLabel = /*@__PURE__*/ defineContainer<JSX.SixMenuLabel>('six-menu-label', undefined);

export const SixPicto = /*@__PURE__*/ defineContainer<JSX.SixPicto>('six-picto', undefined, ['size']);

export const SixProgressBar = /*@__PURE__*/ defineContainer<JSX.SixProgressBar>('six-progress-bar', undefined, ['percentage', 'indeterminate']);

export const SixProgressRing = /*@__PURE__*/ defineContainer<JSX.SixProgressRing>('six-progress-ring', undefined, ['size', 'strokeWidth', 'percentage']);

export const SixRadio = /*@__PURE__*/ defineContainer<JSX.SixRadio>(
  'six-radio',
  undefined,
  ['name', 'value', 'disabled', 'checked', 'invalid', 'six-radio-blur', 'six-radio-change', 'six-radio-focus'],
  'value',
  'six-radio-change',
);

export const SixRange = /*@__PURE__*/ defineContainer<JSX.SixRange>(
  'six-range',
  undefined,
  [
    'name',
...
export const SixRoot = /*@__PURE__*/ defineContainer<JSX.SixRoot>('six-root', undefined, ['breakpoint', 'padded', 'stage', 'version', 'six-root-collapsed']);

export const SixSearchField = /*@__PURE__*/ defineContainer<JSX.SixSearchField>(
  'six-search-field',
  undefined,
  ['placeholder', 'debounce', 'disabled', 'value', 'clearable', 'six-search-field-change'],
  'value',
  'six-search-field-change',
);

export const SixSelect = /*@__PURE__*/ defineContainer<JSX.SixSelect>(
  'six-select',
  undefined,
  [
    'multiple',
...
export const SixSidebarItem = /*@__PURE__*/ defineContainer<JSX.SixSidebarItem>('six-sidebar-item', undefined, ['value', 'selected', 'disabled']);

export const SixSidebarItemGroup = /*@__PURE__*/ defineContainer<JSX.SixSidebarItemGroup>('six-sidebar-item-group', undefined, ['name', 'icon', 'value', 'open', 'summaryIcon']);

export const SixSpinner = /*@__PURE__*/ defineContainer<JSX.SixSpinner>('six-spinner', undefined, ['six']);

export const SixStageIndicator = /*@__PURE__*/ defineContainer<JSX.SixStageIndicator>('six-stage-indicator', undefined, ['stage']);

export const SixSwitch = /*@__PURE__*/ defineContainer<JSX.SixSwitch>(
  'six-switch',
  undefined,
  ['name', 'value', 'disabled', 'required', 'checked', 'invalid', 'six-switch-blur', 'six-switch-change', 'six-switch-focus'],
  'checked',
  'six-switch-change',
);

export const SixTab = /*@__PURE__*/ defineContainer<JSX.SixTab>('six-tab', undefined, ['panel', 'active', 'closable', 'disabled', 'six-tab-close']);

export const SixTabGroup = /*@__PURE__*/ defineContainer<JSX.SixTabGroup>('six-tab-group', undefined, ['placement', 'noScrollControls', 'six-tab-show', 'six-tab-hide']);

export const SixTabPanel = /*@__PURE__*/ defineContainer<JSX.SixTabPanel>('six-tab-panel', undefined, ['name', 'active']);
...
export const SixTag = /*@__PURE__*/ defineContainer<JSX.SixTag>('six-tag', undefined, ['type', 'size', 'pill', 'clearable', 'six-tag-clear']);

export const SixTextarea = /*@__PURE__*/ defineContainer<JSX.SixTextarea>(
  'six-textarea',
  undefined,
  [
    'size',
