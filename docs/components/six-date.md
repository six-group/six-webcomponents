...
A standard date picker with a label.
...
Use the `value` attribute to set the date picker's value.
...
```html
<six-date label="Only weekends allowed"></six-date>

<script type="module">
  const weekendPicker = document.querySelector('six-date[label="Only weekends allowed"]');

  // You can also set the function programmatically
  weekendPicker.allowedDates = (date) => {
...
Add the `clearable` attribute to show a clear button when the date picker has a value.
...
Add the `required` attribute to make the date picker a required field.
...
| ---------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ----------------------- |
| `allowedDates`   | --                 | Callback to determine which dates in the datepicker should be selectable.                                                                                                                                           | `(date: `${number}${number}${number}${number}-${number}${number}-${number}${number}`) => boolean` | `() => true`            |
