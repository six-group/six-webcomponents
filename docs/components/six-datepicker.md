...
If you need to select a date range including times, set the `type` property to `date-time-range`

The user will need to set the time for each date (default being now).
...
| `closeOnSelect`     | `close-on-select`  | Closes the datepicker dropdown after selection                                                                                                                                                                                                                                                                                   | `boolean`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `this.type === 'date' \|\| this.type === 'date-range'` |
...
| `dateFormat`        | `date-format`      | Define the dateFormat. Valid formats are: 'dd.mm.yyyy' 'yyyy-mm-dd' 'dd-mm-yyyy' 'dd/mm/yyyy' 'yyyy/mm/dd' 'dd.mm.yy' 'yy-mm-dd' 'dd-mm-yy' 'dd/mm/yy' 'yy/mm/dd'                                                                                                                                                                | `SixDateFormats.DDMMYYYY_DASH \| SixDateFormats.DDMMYYYY_DASH_TIME \| SixDateFormats.DDMMYYYY_DOT \| SixDateFormats.DDMMYYYY_SLASH \| SixDateFormats.DDMMYYYY_SLASH_TIME \| SixDateFormats.DDMMYYY_DOT_TIME \| SixDateFormats.DDMMYY_DASH \| SixDateFormats.DDMMYY_DASH_TIME \| SixDateFormats.DDMMYY_DOT \| SixDateFormats.DDMMYY_DOT_TIME \| SixDateFormats.DDMMYY_SLASH \| SixDateFormats.DDMMYY_SLASH_TIME \| SixDateFormats.YYMMDD_DASH \| SixDateFormats.YYMMDD_DASH_TIME \| SixDateFormats.YYMMDD_SLASH \| SixDateFormats.YYMMDD_SLASH_TIME \| SixDateFormats.YYYYMMDD_DASH \| SixDateFormats.YYYYMMDD_DASH_TIME \| SixDateFormats.YYYYMMDD_SLASH \| SixDateFormats.YYYYMMDD_SLASH_TIME` | `SixDateFormats.DDMMYYYY_DOT`                          |
...
| `range`             | --                 | The value of the form field, which accepts a SixDateRange object if 'type' is 'date-range' or 'date-time-range'.                                                                                                                                                                                                                 | `undefined \| { from: Date \| null; to: Date \| null; }`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | `undefined`                                            |
...
| `type`              | `type`             | Set the type.                                                                                                                                                                                                                                                                                                                    | `"date" \| "date-range" \| "date-time" \| "date-time-range"`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `'date'`                                               |
| `value`             | --                 | The value of the form field, which accepts a date object if 'type' is not 'date-range' and not 'date-time-range'.                                                                                                                                                                                                                | `Date \| undefined`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `undefined`                                            |
...
| `six-datepicker-select-range` | Emitted when a range got selected.          | `CustomEvent<null \| undefined \| { from: Date \| null; to: Date \| null; }>` |
